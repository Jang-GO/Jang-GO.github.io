...
<!--more-->
> 본 글은 [스프링 웹 소켓 알아보기](/스프링/2024/11/21/스프링-웹-소켓-알아보기/) 포스팅 이후 프로젝트를 진행하기 위한 포스팅입니다.<br>
...
시작으로 실시간 채팅을 구현하기 전, 스프링 공식문서 가이드에서 제공하는 템플릿을 실습해보며 다시한번 코드 작성과 구조에 대하여 파악해보려고 한다.<br><br>
